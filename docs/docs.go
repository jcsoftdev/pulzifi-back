...
const docTemplate = `{
    ...
    "paths": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/handlers.GetOrganizationResponseDTO"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/usage/admin/organizations/{id}/gift-month": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
    ...
    "definitions": {
        ...
        "handlers.GetOrganizationResponseDTO": {
            "type": "object",
            "properties": {
                "created_at": {
                    "type": "string",
                    "example": "2025-11-11T12:58:42Z"
                },
                "id": {
                    "type": "string",
