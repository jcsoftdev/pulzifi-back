...
import { AUTO_COLLAPSE_DELAY, AUTO_EXPAND_DELAY, SWIPE_DISMISS_THRESHOLD } from '../../constants'
...
export function ToastItem({
  ...
  if (toast.render) {
    return (
      // biome-ignore lint/a11y/noStaticElementInteractions: toast div has dynamic role assigned at runtime
      // biome-ignore lint/a11y/useAriaPropsSupportedByRole: aria-label needed for toast accessibility; role is dynamic
      <div
        ref={ref}
        role={ariaRole}
