import { AUTO_COLLAPSE_DELAY, AUTO_EXPAND_DELAY, DEFAULT_TOAST_DURATION } from '../../constants'
import type { NotixOptions, NotixPosition, ToastData } from './types'
...
export function updateToastData(existing: ToastData, updates: Partial<NotixOptions>): ToastData {
  ...
  return {
    ...
    duration,
    showProgress: updates.showProgress ?? existing.showProgress ?? false,
    styles: {
      ...existing.styles,
      ...updates.styles,
    },
