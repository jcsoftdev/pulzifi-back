              ...
              <div className="flex flex-col gap-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a
                      href={`mailto:${email}`}
                      className="text-base font-semibold text-[var(--pz-ink)] transition-colors hover:text-[var(--pz-accent)]"
                    >
                      {email}
                    </a>
                  </div>
            ...
            <div className="rounded-2xl border border-[var(--pz-card-border)] bg-white p-8 shadow-[var(--pz-card-shadow-rest)] lg:col-span-3 md:p-10">
              {submitted ? (
                <div className="flex flex-col items-center justify-center gap-4 py-12 text-center">
                  ...
                  <p className="text-sm text-[var(--pz-ink-2)]">
                  ...
                  <button
                    ...
                    className="text-sm font-medium text-[var(--pz-accent)] hover:underline"
                  >
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-6">
                  <div className="flex flex-col gap-4 sm:flex-row">
                    <div className="flex flex-1 flex-col gap-2">
                      <label htmlFor={nameId} className="text-sm font-medium text-[var(--pz-ink)]">
                        Your name
                      </label>
                      <input
                        id={nameId}
                    ...
                    <div className="flex flex-1 flex-col gap-2">
                      <label htmlFor={emailId} className="text-sm font-medium text-[var(--pz-ink)]">
                        Email address
                      </label>
                      <input
                        id={emailId}
                  ...
                  <div className="flex flex-col gap-2">
                    <label htmlFor={messageId} className="text-sm font-medium text-[var(--pz-ink)]">
                      Message
                    </label>
                    <textarea
                      id={messageId}
                      ...
                      className={cn(
                        'min-h-[160px] resize-none rounded-xl border border-[var(--pz-card-border)] bg-[var(--pz-page-bg-alt)] px-5 py-4 text-base text-[var(--pz-ink)] outline-none placeholder:text-[var(--pz-ink-2)]/50 focus:border-[var(--pz-accent)]/40 focus:ring-2 focus:ring-[var(--pz-accent)]/20 transition-colors'
                      )}
                    />
                  </div>
                  <button
