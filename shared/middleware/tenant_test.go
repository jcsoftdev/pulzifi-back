...
func TestIsPublicPath(t *testing.T) {
	...
	tests := []struct {
		...
		{"auth invitations base", "/auth/invitations", true},
		{"auth invitations token", "/auth/invitations/abc123", true},
		{"auth invitations accept", "/auth/invitations/abc123/accept", true},
